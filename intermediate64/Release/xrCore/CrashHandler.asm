...
; 1201 :         DWORD dwOpts = SymGetOptions ( ) ;
	...
	mov	DWORD PTR dwOpts$99691[rsp], eax
...
; 1206 :                         SYMOPT_LOAD_LINES      ) ;
	...
	mov	eax, DWORD PTR dwOpts$99691[rsp]
	or	eax, 4
	or	eax, 64					; 00000040H
	or	eax, 2
	or	eax, 16
...
; 1210 :         HANDLE hPID = (HANDLE)GetCurrentProcessId ( ) ;
	...
	call	QWORD PTR __imp_GetCurrentProcessId
	mov	eax, eax
	mov	QWORD PTR hPID$99692[rsp], rax
...
; 1214 :                                     TRUE         ) ) ;
	...
	mov	rdx, QWORD PTR hPID$99692[rsp]
	mov	ecx, DWORD PTR hPID$99692[rsp]
...
xdata	SEGMENT
$unwind$?InternalGetStackTraceString@@YAPEBDKPEAU_EXCEPTION_POINTERS@@@Z DD 021009H
	DD	0150110H
	DD	imagerel __C_specific_handler
	DD	01H
	DD	imagerel $LN28+59
	DD	imagerel $LN28+1482
...
; 726  :                                   NULL                               ) ;
	...
	mov	DWORD PTR bSWRet$99516[rsp], eax

; 727  :         if ( ( FALSE == bSWRet ) || ( 0 == g_stFrame.AddrFrame.Offset ))

	cmp	DWORD PTR bSWRet$99516[rsp], 0
...
; 749  :         int iCurr = 0 ;
	...
	mov	DWORD PTR iCurr$99530[rsp], 0
...
; 755  :                             g_stFrame.AddrPC.Offset  ) ;
	...
	movsxd	rax, DWORD PTR iCurr$99530[rsp]
	lea	rcx, OFFSET FLAT:g_szBuff
	add	rcx, rax
	mov	rax, rcx
	...
	mov	ecx, DWORD PTR iCurr$99530[rsp]
	add	ecx, eax
	mov	eax, ecx
	mov	DWORD PTR iCurr$99530[rsp], eax
...
; 772  :                                 g_stFrame.Params[ 3 ]      ) ;
	...
	add	rcx, rax
	mov	rax, rcx
	mov	rcx, QWORD PTR g_stFrame+112
	mov	QWORD PTR [rsp+40], rcx
	mov	rcx, QWORD PTR g_stFrame+104
	mov	QWORD PTR [rsp+32], rcx
	mov	r9, QWORD PTR g_stFrame+96
	mov	r8, QWORD PTR g_stFrame+88
...
; 808  :                                       pSym                            ))
	...
	call	QWORD PTR __imp_GetCurrentProcessId
	mov	eax, eax
	mov	r9, QWORD PTR pSym$99539[rsp]
	lea	r8, QWORD PTR dwDisp$99537[rsp]
	mov	rdx, QWORD PTR g_stFrame
	mov	ecx, eax
...
; 819  :                                BUFF_SIZE - iCurr - 1  ) ;
	...
	mov	rcx, QWORD PTR pSym$99539[rsp]
	add	rcx, 28
	movsxd	rdx, DWORD PTR iCurr$99530[rsp]
	lea	r8, OFFSET FLAT:g_szBuff
	add	r8, rdx
	mov	rdx, r8
...
; 826  :                     if ( dwDisp > 0 )
	...
	cmp	DWORD PTR dwDisp$99537[rsp], 0
...
; 831  :                                             dwDisp                   );
	...
	add	rdx, rcx
	mov	rcx, rdx
	mov	r9d, DWORD PTR dwDisp$99537[rsp]
	mov	r8, rax
...
; 889  :                                           dwDisp                     );
	...
	add	rcx, rax
	mov	rax, rcx
	mov	ecx, DWORD PTR dwDisp$99537[rsp]
...
; 301  :             BOOL bCallIt = FALSE ;
	...
	mov	DWORD PTR bCallIt$99400[rsp], 0
...
; 304  :                 bCallIt = TRUE ;
	...
	mov	DWORD PTR bCallIt$99400[rsp], 1
...
; 312  :                                                       ExceptionAddress);
	...
	mov	ecx, eax
	call	QWORD PTR __imp_SymGetModuleBase64
	mov	QWORD PTR hBaseAddr$99403[rsp], rax

; 313  :                 if ( NULL != hBaseAddr )

	cmp	QWORD PTR hBaseAddr$99403[rsp], 0
	je	SHORT $LN10@CrashHandl

; 314  :                 {
; 315  :                     for ( UINT i = 0 ; i < g_uiModCount ; i ++ )

	mov	DWORD PTR i$99408[rsp], 0
	jmp	SHORT $LN8@CrashHandl
$LN7@CrashHandl:
	mov	eax, DWORD PTR i$99408[rsp]
	inc	eax
	mov	DWORD PTR i$99408[rsp], eax
$LN8@CrashHandl:
	mov	eax, DWORD PTR g_uiModCount
	cmp	DWORD PTR i$99408[rsp], eax
...
; 317  :                         if ( hBaseAddr == g_ahMod[ i ] )
	...
	cmp	QWORD PTR hBaseAddr$99403[rsp], rax
...
; 325  :             if ( TRUE == bCallIt )
	...
	cmp	DWORD PTR bCallIt$99400[rsp], 1
