...
pdata	SEGMENT
$pdata$?NTGetModuleBaseName@@YAKPEAXPEAUHINSTANCE__@@PEADK@Z DD imagerel $LN4
	DD	imagerel $LN4+98
...
pdata	SEGMENT
$pdata$?NT4GetLoadedModules@@YAHKIPEAPEAUHINSTANCE__@@PEAK@Z DD imagerel $LN11
	DD	imagerel $LN11+71
	DD	imagerel $unwind$?NT4GetLoadedModules@@YAHKIPEAPEAUHINSTANCE__@@PEAK@Z
$pdata$0$?NT4GetLoadedModules@@YAHKIPEAPEAUHINSTANCE__@@PEAK@Z DD imagerel $LN11+71
	DD	imagerel $LN11+285
	DD	imagerel $chain$0$?NT4GetLoadedModules@@YAHKIPEAPEAUHINSTANCE__@@PEAK@Z
$pdata$1$?NT4GetLoadedModules@@YAHKIPEAPEAUHINSTANCE__@@PEAK@Z DD imagerel $LN11+285
...
; 183  :     *pdwRealCount = dwTotal / sizeof ( HMODULE ) ;
	...
	mov	r11d, DWORD PTR dwTotal$[rsp]
	mov	eax, r11d
	shr	eax, 3
