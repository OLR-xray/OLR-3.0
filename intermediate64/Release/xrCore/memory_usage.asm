...
pdata	SEGMENT
$pdata$?mem_usage_impl@@YAIPEAXPEAI1@Z DD imagerel $LN22
	DD	imagerel $LN22+241
...
$pdata$?mem_usage@xrMemory@@QEAAIPEAI0@Z DD imagerel $LN4
	DD	imagerel $LN4+46
...
; 47   :         Entry.wFlags = 0;
	...
	xor	edi, edi
	mov	WORD PTR [rax-50], di

; 48   :         Entry.iRegionIndex = 0;

	mov	BYTE PTR [rax-51], dil
...
; 77   :                 errflag = 2;
	...
	mov	r14, QWORD PTR heap_handle$[rsp]
$LN24@heap_walk:
